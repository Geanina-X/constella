...
export const presetRelationships: Relationship[] = [
  // ── Word → Root (词根) ──
  // -tain
  { id: 'r1',  sourceId: wid('retain'),    targetId: wid('root-tain'), type: 'root-share', label: '词根', notes: '' },
  { id: 'r2',  sourceId: wid('contain'),   targetId: wid('root-tain'), type: 'root-share', label: '词根', notes: '' },
  { id: 'r3',  sourceId: wid('maintain'),  targetId: wid('root-tain'), type: 'root-share', label: '词根', notes: '' },
  { id: 'r4',  sourceId: wid('sustain'),   targetId: wid('root-tain'), type: 'root-share', label: '词根', notes: '' },
  { id: 'r5',  sourceId: wid('obtain'),    targetId: wid('root-tain'), type: 'root-share', label: '词根', notes: '' },
  { id: 'r6',  sourceId: wid('detain'),    targetId: wid('root-tain'), type: 'root-share', label: '词根', notes: '' },
  { id: 'r7',  sourceId: wid('retention'), targetId: wid('root-tain'), type: 'root-share', label: '词根', notes: '' },
  // -spect
  { id: 'r8',  sourceId: wid('inspect'),    targetId: wid('root-spect'), type: 'root-share', label: '词根', notes: '' },
  { id: 'r9',  sourceId: wid('respect'),    targetId: wid('root-spect'), type: 'root-share', label: '词根', notes: '' },
  { id: 'r10', sourceId: wid('prospect'),   targetId: wid('root-spect'), type: 'root-share', label: '词根', notes: '' },
  { id: 'r11', sourceId: wid('suspect'),    targetId: wid('root-spect'), type: 'root-share', label: '词根', notes: '' },
  { id: 'r12', sourceId: wid('retrospect'), targetId: wid('root-spect'), type: 'root-share', label: '词根', notes: '' },
  // -dict
  { id: 'r13', sourceId: wid('predict'),    targetId: wid('root-dict'), type: 'root-share', label: '词根', notes: '' },
  { id: 'r14', sourceId: wid('contradict'), targetId: wid('root-dict'), type: 'root-share', label: '词根', notes: '' },
  { id: 'r15', sourceId: wid('indicate'),   targetId: wid('root-dict'), type: 'root-share', label: '词根', notes: '' },
  // -duct
  { id: 'r16', sourceId: wid('conduct'),   targetId: wid('root-duct'), type: 'root-share', label: '词根', notes: '' },
  { id: 'r17', sourceId: wid('produce'),   targetId: wid('root-duct'), type: 'root-share', label: '词根', notes: '' },
  { id: 'r18', sourceId: wid('reduce'),    targetId: wid('root-duct'), type: 'root-share', label: '词根', notes: '' },
  { id: 'r19', sourceId: wid('introduce'), targetId: wid('root-duct'), type: 'root-share', label: '词根', notes: '' },
  { id: 'r20', sourceId: wid('deduce'),    targetId: wid('root-duct'), type: 'root-share', label: '词根', notes: '' },
  // -mit
  { id: 'r21', sourceId: wid('transmit'), targetId: wid('root-mit'), type: 'root-share', label: '词根', notes: '' },
  { id: 'r22', sourceId: wid('commit'),   targetId: wid('root-mit'), type: 'root-share', label: '词根', notes: '' },
  { id: 'r23', sourceId: wid('submit'),   targetId: wid('root-mit'), type: 'root-share', label: '词根', notes: '' },
  { id: 'r24', sourceId: wid('dismiss'),  targetId: wid('root-mit'), type: 'root-share', label: '词根', notes: '' },
  { id: 'r25', sourceId: wid('permit'),   targetId: wid('root-mit'), type: 'root-share', label: '词根', notes: '' },
  // -scribe
  { id: 'r26', sourceId: wid('describe'),  targetId: wid('root-scribe'), type: 'root-share', label: '词根', notes: '' },
  { id: 'r27', sourceId: wid('prescribe'), targetId: wid('root-scribe'), type: 'root-share', label: '词根', notes: '' },
  { id: 'r28', sourceId: wid('subscribe'), targetId: wid('root-scribe'), type: 'root-share', label: '词根', notes: '' },
  // -gress
  { id: 'r29', sourceId: wid('progress'),   targetId: wid('root-gress'), type: 'root-share', label: '词根', notes: '' },
  { id: 'r30', sourceId: wid('aggressive'), targetId: wid('root-gress'), type: 'root-share', label: '词根', notes: '' },
  // -vene
  { id: 'r31', sourceId: wid('intervene'), targetId: wid('root-vene'), type: 'root-share', label: '词根', notes: '' },
  { id: 'r32', sourceId: wid('prevent'),   targetId: wid('root-vene'), type: 'root-share', label: '词根', notes: '' },

  // ── Word → Prefix (前缀) ──
  { id: 'p1', sourceId: wid('retain'),    targetId: wid('pref-re'),  type: 'prefix-share', label: '前缀', notes: '' },
  { id: 'p2', sourceId: wid('respect'),   targetId: wid('pref-re'),  type: 'prefix-share', label: '前缀', notes: '' },
  { id: 'p3', sourceId: wid('reduce'),    targetId: wid('pref-re'),  type: 'prefix-share', label: '前缀', notes: '' },
  { id: 'p4', sourceId: wid('predict'),   targetId: wid('pref-pre'), type: 'prefix-share', label: '前缀', notes: '' },
  { id: 'p5', sourceId: wid('prescribe'), targetId: wid('pref-pre'), type: 'prefix-share', label: '前缀', notes: '' },
  { id: 'p6', sourceId: wid('prevent'),   targetId: wid('pref-pre'), type: 'prefix-share', label: '前缀', notes: '' },
  { id: 'p7', sourceId: wid('prospect'),  targetId: wid('pref-pro'), type: 'prefix-share', label: '前缀', notes: '' },
  { id: 'p8', sourceId: wid('produce'),   targetId: wid('pref-pro'), type: 'prefix-share', label: '前缀', notes: '' },
  { id: 'p9', sourceId: wid('progress'),  targetId: wid('pref-pro'), type: 'prefix-share', label: '前缀', notes: '' },
  { id: 'p10', sourceId: wid('contain'),   targetId: wid('pref-con'), type: 'prefix-share', label: '前缀', notes: '' },
  { id: 'p11', sourceId: wid('conduct'),   targetId: wid('pref-con'), type: 'prefix-share', label: '前缀', notes: '' },

  // ── Synonym (同义) ──
  { id: 's1', sourceId: wid('retain'),   targetId: wid('keep'),     type: 'synonym', label: '同义', notes: '' },
  { id: 's2', sourceId: wid('retain'),   targetId: wid('maintain'), type: 'synonym', label: '同义', notes: '' },
  { id: 's3', sourceId: wid('retain'),   targetId: wid('remember'), type: 'synonym', label: '同义(记)', notes: '' },
  { id: 's4', sourceId: wid('retain'),   targetId: wid('employ'),   type: 'synonym', label: '同义(雇)', notes: '' },
  { id: 's5', sourceId: wid('lucid'),    targetId: wid('clear'),    type: 'synonym', label: '同义', notes: '' },
  { id: 's6', sourceId: wid('clear'),    targetId: wid('obvious'),  type: 'synonym', label: '同义', notes: '' },
  { id: 's7', sourceId: wid('obvious'),  targetId: wid('apparent'), type: 'synonym', label: '同义', notes: '' },
  { id: 's8', sourceId: wid('apparent'), targetId: wid('evident'),  type: 'synonym', label: '同义', notes: '' },
  { id: 's9', sourceId: wid('evident'),  targetId: wid('explicit'), type: 'synonym', label: '同义', notes: '' },

  // ── Antonym (反义) ──
  { id: 'a1', sourceId: wid('retain'),       targetId: wid('release'),     type: 'antonym', label: '反义', notes: '' },
  { id: 'a2', sourceId: wid('remember'),     targetId: wid('forget'),      type: 'antonym', label: '反义', notes: '' },
  { id: 'a3', sourceId: wid('optimistic'),   targetId: wid('pessimistic'), type: 'antonym', label: '反义', notes: '' },
  { id: 'a4', sourceId: wid('include'),      targetId: wid('exclude'),     type: 'antonym', label: '反义', notes: '' },

  // ── Derivative (词族) ──
  { id: 'd1', sourceId: wid('retain'),   targetId: wid('retention'), type: 'derivative', label: 'n.形式', notes: '' },
];
