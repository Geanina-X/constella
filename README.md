...
4. 点「+ 新建」创建单词或词根词缀
5. 点击单词 → 释义按词性分组展示，点 📝 写备注（有备注时按钮会高亮，不点开也能看到预览）
6. 添加同义词、反义词、词根关联，每条关系都能写辨析笔记（📝 辨析），每加一个关系星图上就多一颗星
7. 新建单词后会自动聚焦到该词，不用在星图里找
8. 搜索框输入不存在的词 → 直接点新建，词已预填好
9. 点喇叭 🔊 按钮可以听单词发音（浏览器自带，不用联网）

### 关系类型
- **同义**（绿）/ **反义**（红）
- **词根/前缀/后缀**（棕/紫/蓝）
- **关联词根**（琥珀）—— 词根词缀之间的近义/反义关系
- **词族**（橙）—— 派生词
- **形近**（青）
